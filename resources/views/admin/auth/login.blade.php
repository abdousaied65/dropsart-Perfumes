                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 text-center"><a href="{{route('index')}}"><img
                                        ...
                                        <h1 class=" ml-1 mr-0 my-auto tx-28"> Drops Art </h1></div>
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input id="password" type="password"
                                                               ...
                                                               dir="ltr" name="password" required autocomplete="off"
                                            ...
                                            @if (Route::has('admin.password.request'))
                                                <a class="btn btn-link mt-1 pull-right" href="{{ route('admin.password.request') }}">
                                                    هل نسيت كلمة المرور ؟
                                                </a>
                                            @endif
                                        </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img src="{{URL::asset('assets/img/brand/logo.png')}}" class="w-50 h-50" alt="logo">
                    </div>
                </div>
            </div>
