                        ...
                        <div class="col-lg-3 col-md-4">
                            ...
                            <ul class="list-group list-group-divider inbox-list">
                                <li class="list-group-item">
                                    <a href="{{route('admin.contacts.index')}}"><i class="fa fa-inbox"></i> البريد الوارد <i
                                            class="fa fa-circle text-warning"></i>
                                    </a>
                                </li>
                                <li class="list-group-item">
                                    <a href="{{route('admin.contacts.important')}}"><i class="fa fa-star"></i> الرسائل المهمة <i
                            ...
                            <div class="ibox p-3" id="mailbox-container">
                                <div class="mailbox-header">
                                    ...
                                    <div class="d-flex justify-content-between inbox-toolbar p-t-20">
                                        ...
                                        @else
                                            <div class="alert alert-sm alert-danger m-3 text-center w-100">لا يوجد رسائل</div>
                                        @endif
                                    </div>
                                </div>
