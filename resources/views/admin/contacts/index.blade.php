                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            <h5 class="alert alert-md alert-success">عرض رسائل الزوار </h5>
                        </div>
                        <br>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row mailbox">
                        <div class="col-lg-3 col-md-4">
                            <h6 class="m-t-10 m-b-10">تصنيفات الرسائل</h6>
                            <ul class="list-group list-group-divider inbox-list">
                                <li class="list-group-item">
                                    <a href="{{route('admin.contacts.index')}}"><i class="fa fa-inbox"></i> البريد
                                        الوارد ({{$data->total()}}) <i
                            ...
                            <div class="ibox p-3" id="mailbox-container">
                                <div class="mailbox-header">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="d-none d-lg-block inbox-title ml-3"><i
                                                class="fa fa-envelope-o m-r-5"></i> البريد الوارد ({{$data->total()}})
                                        </h5>
                                    </div>
                                    <div class="d-flex justify-content-between inbox-toolbar p-t-20">
                                                ...
                                                <div id="inbox-actions" class="m-l-20 m-r-20">
                                                    <form class="d-inline" method="post">
                                                        ...
                                                        <button formaction="{{route('admin.contacts.make.as.read')}}"
                                                                ...
                                                                data-original-title="تعيين كمقروء"><i
                                                                class="fa fa-eye"></i>
                                                        </button>
                                                        <button
                                                            formaction="{{route('admin.contacts.make.as.important')}}"
                                                            type="submit"
                                                            class="btn btn-default btn-sm" data-toggle="tooltip"
                                                            data-original-title="تعيين كمهمة"><i
                                        ...
                                        @else
                                            <div class="alert alert-sm alert-danger m-3 text-center w-100">لا بوجد
                                                رسائل
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="mailbox clf">
                                        ...
                                        @foreach($data as $msg)
                                            <tr>
                                                ...
                                                <td>@if($msg->status == 0) <i
                                                        class="fa fa-circle text-warning"></i> @elseif($msg->status == 2)
                                                        <i
                                    ...
                                    <span @if(App::getLocale()=="ar") dir="rtl" class="text-right pull-right"
                                          @else dir="ltr"
                                          class="text-left pull-left"  @endif> عرض الرسائل : {{ $data->total() }}</span>
