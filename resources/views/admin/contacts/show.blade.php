                            ...
                            <ul class="list-group list-group-divider inbox-list">
                                <li class="list-group-item">
                                    <a href="{{route('admin.contacts.index')}}"><i
                                            class="fa fa-inbox"></i> البريد الوارد <i
                                ...
                                <form class="d-inline" method="post">
                                    ...
                                    <div class="mailbox-header d-flex justify-content-between"
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div
                                                class="pr-3 mt-3 font-13">{{$message->created_at->diffForHumans()}}</div>
                                        </div>
                                        ...
                                        <div class="inbox-toolbar m-l-20">
                                            <button class="btn btn-default btn-sm" data-toggle="tooltip"
                                                    formaction="{{route('admin.contacts.make.as.destroy')}}"
                                                    type="submit"
